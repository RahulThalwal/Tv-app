...
import { Container } from "../../style/global/default";
import { BrandWrapper, HeaderIconsWrapper, HeaderWrapper, NavWrapper, } from "./Header.styles";
import { Images } from "../../assets/images";
import { Icons } from "../../assets/icons";
import { Link, useLocation } from "react-router-dom";
import useHeaderbackground from "../../hooks/hasHeaderbackgroud";
      ...
      <Container className="w-full">
        <div className="header-content flex items-center justify-between">
          ...
          >
            <button
              type="button"
              className="sidebar-close-btn" onClick={() => dispatch(closeSidebar())}>
              <img src={Icons.Close} alt="" />
            </button>
            <ul className="nav-list flex items-center justify-center bg-black06">
              <li className="nav-item">
                <Link onClick={handleNavLinkClick} to={routeConstants.HOME} className={`nav-link inline-flex items-center justify-center text-center ${location.pathname === routeConstants.HOME ? "active" : ""}`}>Home
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  ...
                  className={`nav-link inline-flex items-center justify-center text-center ${location.pathname === routeConstants.SHOWS ? "active" : ""}`}>
                  Shows
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  onClick={handleNavLinkClick}
                  to="/support"
                  className={`nav-link inline-flex items-center justify-center text-center ${location.pathname === "/support" ? "active" : ""
                    }`}
                >
                  Support
                </Link>
              ...
              <li className="nav-item">
                <Link
                  onClick={handleNavLinkClick}
                  to="/subscription"
                  className={`nav-link inline-flex items-center justify-center text-center ${location.pathname === "/subscription" ? "active" : ""
                    }`}
                >
                  Subscription
                </Link>
          ...
          <HeaderIconsWrapper className="flex items-center">
            ...
            <button
              type="button"
              className="icon-link flex items-center justify-center sidebar-open-btn" onClick={() => dispatch(openSidebar())}
